...
export class BreadcrumbCategory extends Component {
  render() {
    const { title, category, subCategory } = this.props;
    return (
      <Fragment>
        <div className="breadcrumb-wrapper bgimage overlay overlay--dark content_above">
