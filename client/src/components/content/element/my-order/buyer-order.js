...
class BuyerOrder extends Component {
  ...
  componentDidMount() {
    axios.get("/api/order/get-buyer-order?user_id=" + this.props.login._id )
      .then((res) => {
                          ...
                          <div className="col-lg-5">
                            {
                              order.status === "PENDING" && (
                                <div className="order-detail">
                                  <span className="badge badge-success"><i className="las la-check-circle"></i> Preparing order</span>
                                </div>
                              )
                            }
                          </div>
...
export default connect(mapStateToProps, mapDispatchToProp)(BuyerOrder);
