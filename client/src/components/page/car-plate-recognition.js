...
class CarPlateRecognition extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: false,
  ...
  pushPhoto(file) {
    ...
    const apiUrl = `/api/info/car-plate-recognition`;
    axios
      .post(
        apiUrl,
        formData,
  ...
  render() {
    ...
    return (
      <Fragment>
        <PreHeader />
        <Header />
        <PageBanner title={t("plate_recog_title")} />
          ...
          >
            ...
            <ModalBody className="text-center">
              <FormGroup row>
                ...
                <Col md="8">
                    <span>{details && details.plateNumber && details.plateNumber.toUpperCase()}</span>
                </Col>
              </FormGroup>
              <FormGroup row>
                <Col md="4">
                ...
                <Col md="8">
                  <span>{details && details.countries && details.countries}</span>
                </Col>
              </FormGroup>
              <FormGroup row>
                <Col md="4">
                ...
                <Col md="8">
                  <span>{details && details.provience && details.provience}</span>
                </Col>
              </FormGroup>
            </ModalBody>
...
export default compose(withTranslation(), connect(mapStateToProps, mapDispatchToProp))(CarPlateRecognition);
